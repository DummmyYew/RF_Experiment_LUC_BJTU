...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\sat.tet
...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\model.gex
...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\bc3d.tet
...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\objectid.tet
...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\meshrelated.info
...
result=s:0
parametric=s:P
files=s:parMesh\MMID_0\3d.slim
...
result=s:1
parametric=s:P
treepath=s:1D Results\Materials\FR-4 (lossy)\Dispersive\Eps' (FD - Interpolated)
files=s:FR-4 (lossy)_eps_re Frequency Domain.sig
...
parametric=s:P
treepath=s:1D Results\Materials\FR-4 (lossy)\Dispersive\Eps'' (FD - Interpolated)
files=s:FR-4 (lossy)_eps_im Frequency Domain.sig
...
result=s:1
parametric=s:P
treepath=s:1D Results\Adaptive Meshing\f=4\S-Parameters\S2,1
...
result=s:1
parametric=s:P
treepath=s:1D Results\Adaptive Meshing\f=4\S-Parameters\S1,2
...
result=s:1
parametric=s:P
treepath=s:1D Results\Adaptive Meshing\f=4\S-Parameters\S2,2
...
result=s:1
parametric=s:P
treepath=s:1D Results\Power\Excitation [2]\Loss per Material\Metal loss in [Boundary wall]
files=s:cMetal_loss_[Boundary wall](2).sig
...
result=s:1
parametric=s:P
treepath=s:1D Results\PreservedMeshInformation
files=s:PreservedMeshInformation
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=4) [2]
